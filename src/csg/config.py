"""
src/csg/config.py — Configuration Loader
"""
import yaml
from pathlib import Path

def load_config(config_path: str = "csg.config.yaml") -> dict:
    """Membaca file konfigurasi YAML dengan nilai default."""
...
def get_threshold_for_file(filepath: str, cfg: dict) -> dict:
    """Helper statis (fallback) jika threshold_resolver tidak digunakan."""
    return cfg